...
// const hours = 14;
// const minutes = 26;
// // let timeString = minutes > 0 ? `${hours} h ${minutes} min` : `${hours} h`; // #1a
// let timestring = `${hours} г.${minutes > 0 ? `${minutes} хв.` : ''}`; // #1b
...
// const login = prompt('Give me your login');

// if (login === null) {
//     console.log('Скасовано')
// } else if (login === 'Адмін') {
//     const password = prompt('give me our password');
