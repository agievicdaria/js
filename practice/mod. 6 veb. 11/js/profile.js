...
figureRef.append(figureCaptionRef);
...
const articleintroPaeagraphRef = document.createElement("p");
articleintroPaeagraphRef.textContent =
  "• Michel Legrand (1932 - 2019) was a famous French musician. •";
articleRef.append(articleintroPaeagraphRef);
